...
airport_data = mn_logit_data[["Intercept","Airline", "DepartureTime", "Age", "Destination", "Province"]]
...
airport_data =  logit_data[["Intercept","Foreign_Airline", "DepartureTime", "Age", "Destination", "Province", "Airfare"]]
...
airline_data = logit_data[["Intercept","Airport",  "DepartureTime", "Airfare", "Destination", "Province", "Nationality"]]
...
clf_nn_AL = MLPClassifier(hidden_layer_sizes = (10, 10, 10, 10), activation='tanh', random_state=101)
clf_nn_AL.fit(X_train_AL, y_train_AL)
y_pred_nn_AL = clf_nn_AL.predict(X_test_AL)
